...
Let's apply this to an example. Let's say Party A and Party B are competing in a state with three districts of 14,000 people each.
\begin{center}
\begin{tabular}{ |c|c|c| } 
 \hline
 District & Party A votes & Party B votes \\
 \hline
 01 & \textit{10,000} & 4,000 \\
 \hline
 02 & 6,500 & \textit{7,500} \\
 \hline
 03 & 6,000 & \textit{8,000} \\
 \hline
\end{tabular}
\end{center}

In District 01, Party A wins by an overwhelming margin of 6,000 votes. However, in District 02 and District 03, Party B narrowly wins by margins of 1,000 and 2,000 respectively. From this, we can surmise each party's wasted votes. Remember, wasted votes includes every vote cast for a losing candidate, and every vote cast for a winning candidate beyond the threshold necessary to win.
...
\begin{tabular}{ |c|c|c|c| } 
 ...
 03 & 6,000 & 999 \\
 \hline
 \textbf{State} & \textbf{15,499} & \textbf{5,498} \\
 \hline
\end{tabular}
\end{center}
...
\[\frac{15499 - 5498}{42000} = \frac{10001}{42000} = 0.238\]
