...
We implemented the efficiency gap method into a python application powered by real-world election data in order to determine whether Indiana's state house and senate maps pass or fail the efficiency gap thresholds. 
